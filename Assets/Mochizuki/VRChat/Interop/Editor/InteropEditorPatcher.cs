...
namespace Mochizuki.VRChat.Interop
{
    ...
    public static class InteropEditorPatcher
    {
        ...
        private static readonly Dictionary<string, string> MethodCorrespondenceTable = new Dictionary<string, string>
        {
            ...
            { nameof(EventListener.IsInteract), nameof(EventListener.EmitInteract) },
            { nameof(EventListener.IsDrop), nameof(EventListener.EmitDrop) },
            { nameof(EventListener.IsOwnershipTransferred), nameof(EventListener.EmitOwnershipTransferred) },
            { nameof(EventListener.IsPickup), nameof(EventListener.EmitPickup) },
            { nameof(EventListener.IsPickupUseDown), nameof(EventListener.EmitPickupUseDown) },
            { nameof(EventListener.IsPickupUseUp), nameof(EventListener.EmitPickupUseUp) },
            { nameof(EventListener.IsPlayerJoined), nameof(EventListener.EmitPlayerJoined) },
            { nameof(EventListener.IsPlayerLeft), nameof(EventListener.EmitPlayerLeft) },
            { nameof(EventListener.IsSpawn), nameof(EventListener.EmitSpawn) },
            { nameof(EventListener.IsStationEntered), nameof(EventListener.EmitStationEntered) },
            { nameof(EventListener.IsStationExited), nameof(EventListener.EmitStationExited) },
            { nameof(EventListener.IsVideoEnd), nameof(EventListener.EmitVideoEnd) },
            { nameof(EventListener.IsVideoError), nameof(EventListener.EmitVideoError) },
            { nameof(EventListener.IsVideoLoop), nameof(EventListener.EmitVideoLoop) },
            { nameof(EventListener.IsVideoPause), nameof(EventListener.EmitVideoPause) },
            { nameof(EventListener.IsVideoReady), nameof(EventListener.EmitVideoReady) },
            { nameof(EventListener.IsVideoStart), nameof(EventListener.EmitVideoStart) },
            { nameof(EventListener.IsPlayerTriggerEnter), nameof(EventListener.EmitPlayerTriggerEnter) },
            { nameof(EventListener.IsPlayerTriggerExit), nameof(EventListener.EmitPlayerTriggerExit) },
            { nameof(EventListener.IsPlayerTriggerStay), nameof(EventListener.EmitPlayerTriggerStay) },
            { nameof(EventListener.IsPlayerCollisionEnter), nameof(EventListener.EmitPlayerCollisionEnter) },
            { nameof(EventListener.IsPlayerCollisionExit), nameof(EventListener.EmitPlayerCollisionExit) },
            { nameof(EventListener.IsPlayerCollisionStay), nameof(EventListener.EmitPlayerCollisionStay) },
            { nameof(EventListener.IsPlayerParticleCollision), nameof(EventListener.EmitPlayerParticleCollision) },
            { nameof(EventListener.IsPlayerRespawn), nameof(EventListener.EmitPlayerRespawn) },
            { nameof(EventListener.IsOwnershipRequest), nameof(EventListener.EmitOwnershipRequest) },
            { nameof(EventListener.IsMidiNoteOn), nameof(EventListener.EmitMidiNoteOn) },
            { nameof(EventListener.IsMidiNoteOff), nameof(EventListener.EmitMidiNoteOff) },
            { nameof(EventListener.IsMidiControlChange), nameof(EventListener.EmitMidiControlChange) },
            { nameof(EventListener.IsInputJump), nameof(EventListener.EmitInputJump) },
            { nameof(EventListener.IsInputUse), nameof(EventListener.EmitInputUse) },
            { nameof(EventListener.IsInputGrab), nameof(EventListener.EmitInputGrab) },
            { nameof(EventListener.IsInputDrop), nameof(EventListener.EmitInputDrop) },
            { nameof(EventListener.IsInputMoveHorizontal), nameof(EventListener.EmitInputMoveHorizontal) },
            { nameof(EventListener.IsInputMoveVertical), nameof(EventListener.EmitInputMoveVertical) },
            { nameof(EventListener.IsInputLookHorizontal), nameof(EventListener.EmitInputLookHorizontal) },
            { nameof(EventListener.IsInputLookVertical), nameof(EventListener.EmitInputLookVertical) },
            { nameof(EventListener.IsSomeEventIsEmitted), "" }
        };
